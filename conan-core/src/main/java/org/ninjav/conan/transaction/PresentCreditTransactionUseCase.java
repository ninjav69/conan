 ...
 * @author ninjav
 */
public class PresentCreditTransactionUseCase implements PresentCreditTransactionPort {
    ...
    public List<PresentableTransaction> presentLegacyTransactions() {
        ...
        if (filterText.length() >= 3) {
            List<BankStmtTx> transactions = getGateway().findLegacyCreditTransactionsMatchingReference(filterText);
